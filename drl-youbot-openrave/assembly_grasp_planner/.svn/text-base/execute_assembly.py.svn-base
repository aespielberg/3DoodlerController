...
>>>>>>> .r1790
        ...
        EnableGripperLinks(robot.GetEnv(),robot.GetName(),True) # HACK TODO XXX
...
=======
            MoveArmTo(youbots[robot_name],config.arm_config,planners[robot_name])  # FIXME do we need this?
>>>>>>> .r1790
