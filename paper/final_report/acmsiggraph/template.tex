...
A video of our complete pipeline working in simulation can be seen at \url{https://youtu.be/f8muS50Pp_A}.

A video of some simple 3Doodler primitives made via the YouBot can be seen at \url{http://youtu.be/gLuPqD9eVNw}.
